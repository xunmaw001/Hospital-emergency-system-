          ...
          <el-form-item class="input" label="床位号" prop="chuangweihao">
              <el-input v-model="ruleForm.chuangweihao" 
                placeholder="床位号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="一日价格" prop="yirijiage">
          <el-input v-model="ruleForm.yirijiage" 
              placeholder="一日价格" clearable  :readonly="ro.yirijiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="一日价格" prop="yirijiage">
              <el-input v-model="ruleForm.yirijiage" 
                placeholder="一日价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
                                                    <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="提供设施" prop="tigongsheshi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="提供设施"
                  v-model="ruleForm.tigongsheshi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.tigongsheshi" label="提供设施" prop="tigongsheshi">
                    <span>{{ruleForm.tigongsheshi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	yirijiage : false,
            ...
            ruleForm: {
                  ...
                  yirijiage: [
                            { required: true, message: '一日价格不能为空', trigger: 'blur' },
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.keshi = true;
            continue;
	            	            ...
	            	            if(o=='tigongsheshi'){
            this.ruleForm.tigongsheshi = obj[o];
	    this.ro.tigongsheshi = true;
            continue;
          }
	            	            if(o=='bingfangweizhi'){
	    ...
	    this.ro.chuangweihao = true;
            continue;
	            	            ...
	            	            if(o=='yirijiage'){
            this.ruleForm.yirijiage = obj[o];
	    this.ro.yirijiage = true;
            continue;
          }
	                    }
                                                                                                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yiyuanbingfang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yiyuanbingfangCrossAddOrUpdateFlag = false;
                  this.parent.search();
