          ...
          <el-form-item class="input" v-if="ruleForm.yuyueshijian" label="预约时间" prop="yuyueshijian">
              <el-input v-model="ruleForm.yuyueshijian" 
                placeholder="预约时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="病情描述" prop="bingqingmiaoshu">
          <el-input v-model="ruleForm.bingqingmiaoshu" 
              placeholder="病情描述" clearable  :readonly="ro.bingqingmiaoshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="病情描述" prop="bingqingmiaoshu">
              <el-input v-model="ruleForm.bingqingmiaoshu" 
                placeholder="病情描述" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                            </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jinjiyuyue/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jinjiyuyueCrossAddOrUpdateFlag = false;
                  this.parent.search();
