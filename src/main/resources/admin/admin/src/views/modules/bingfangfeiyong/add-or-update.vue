...
export default {
  ...
  computed: {
                                                                                                            zongfeiyong:{
                                                                                                                                                                                      get: function () {
        return 1*this.ruleForm.yirijiage*this.ruleForm.ruzhutianshu
      }
    },
                                      },
  created() {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `bingfangfeiyong/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.bingfangfeiyongCrossAddOrUpdateFlag = false;
                  this.parent.search();
